...
import { CheckCircle, CheckCircleIcon, MapPinIcon, UserIcon, UserPlusIcon } from "lucide-react";
...
const HomePage = () => {
  ...
  const { data: friendsResponse, isLoading: loadingFriends } = useQuery({
    queryKey: ["friends"],
  ...
  const recommendedUsers = recommendedUserResponse?.data || [];
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="opacity-75">
                  Connect with people around the world and practice languages
                  together.
                </p>
              </div>
            </div>
                    ...
                    <div className="card-body p-5 space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {user.location && (
                            <div className="text-sm flex items-center opacity-75 mt-1">
